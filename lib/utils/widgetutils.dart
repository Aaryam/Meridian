...
class WidgetUtils {
  ...
  static Widget followBar(TextEditingController controller, BuildContext context) {
    return Padding(
      ...
      child: Row(
        children: <Widget>[
          ...
          FlatButton(
            ...
            onPressed: () async {
              await DatabaseUtils.followUser(FirebaseAuth.instance.currentUser!.email as String, controller.value.text);
            },
